...
extern "C" {
  uint64_t a_peak_asimd_fmadd_sp( uint64_t i_n_repetitions );
  uint64_t b_peak_asimd_fmadd_dp( uint64_t i_n_repetitions );
  uint64_t c_peak_asimd_fmla_sp( uint64_t i_n_repetitions );
  uint64_t d_peak_asimd_fmla_dp( uint64_t i_n_repetitions );
}
...
#pragma omp master
    ...
    l_g_flops = a_peak_asimd_fmadd_sp( l_n_repetitions );
#pragma omp barrier
#pragma omp master
    {
...
#pragma omp master
    ...
    l_g_flops = b_peak_asimd_fmadd_dp( l_n_repetitions );
#pragma omp barrier
#pragma omp master
    {
      l_tp1 = std::chrono::steady_clock::now();
...
#pragma omp master
    ...
    l_g_flops = c_peak_asimd_fmla_sp( l_n_repetitions );
#pragma omp barrier
#pragma omp master
    {
      l_tp1 = std::chrono::steady_clock::now();
...
#pragma omp master
    ...
    l_g_flops = d_peak_asimd_fmla_dp( l_n_repetitions );
#pragma omp barrier
#pragma omp master
    {
      l_tp1 = std::chrono::steady_clock::now();
